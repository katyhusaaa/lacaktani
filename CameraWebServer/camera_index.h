...
<html>
    ...
    <body>
        <div id="gps-panel">
            <div style="font-weight:bold; border-bottom:1px solid #00ff00; margin-bottom:10px;">DRONE TELEMETRY</div>
            <div class="stat-line">LAT: <span id="lat">0.000000</span></div>
            <div class="stat-line">LNG: <span id="lng">0.000000</span></div>
            <div class="stat-line">ALT: <span id="alt">0.00</span> m</div>
            <div class="stat-line">SAT: <span id="sat">0</span></div>
        </div>

<script>
    function updateGPS() {
        console.log("Mencoba mengambil data..."); // Log awal
        fetch('/gps?t=' + Date.now())
            .then(response => {
            ...
            .then(data => {
                ...
                console.log("Real-time Sync OK:", data.lat); // Log sukses
            })
            .catch(err => {
                console.error("Gagal total:", err); // Log error
            });
    }
    ...
    updateGPS();
        ...
        <div id="content">
            <img src="" id="stream" style="width:100%;">
        </div>
    </body>
</html>
)=====";
